...
!function (a, b) {
    ...
    return function (a) {
        ...
        (function (b) {
            ...
            function f(a) {
                var b = a.mode, c = a.el, d = a.flags, e = a.engineSettings,
                    f = d.dimensions, h = d.theme, i = f.width + "x" + f.height;
            ...
            function g(a) {
                ...
                var d = null, e = a.mode, f = a.holderSettings, g = a.el,
                    i = a.engineSettings;
                switch (i.renderer) {
                    case"svg":
            ...
            function h(a) {
                ...
                var j = null, k = null;
                if (h.lineCount > 1) {
                    var l = 0, m = 0, n = a.width * K.setup.lineWrapRatio,
                        o = 0;
            ...
            function i(a, b, c) {
                var d = parseInt(a, 10), e = parseInt(b, 10),
                    f = Math.max(d, e), g = Math.min(d, e),
            ...
            var v = c(1), w = c(2), x = c(3), y = x.extend, z = x.cssProps,
                A = x.encodeHtmlEntity, B = x.decodeHtmlEntity,
                C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck,
                ...
                J = {
                    version: H, addTheme: function (a, b) {
                        ...
                        var h = D(g.images), i = D(g.bgnodes),
                            j = D(g.stylenodes), k = D(g.objects);
                    ...
                    if (b.XMLSerializer) {
                        ...
                        return c.appendChild(d), function (b, e) {
                            ...
                            var i = e.holderSettings.flags.holderURL,
                                ...
                                k = o("g", F), l = f.children.holderTextGroup,
                                m = l.properties, n = o("g", F),
                            ...
                            for (var x in l.children) {
                                ...
                                for (var A in y.children) {
                                    var B = y.children[A], C = l.x + y.x + B.x,
                                        D = l.y + y.y + B.y, E = o("text", F),
        ...
        function b(a) {
            ...
            var g = a.document, h = g.documentElement, i = "load", j = !1,
                k = "on" + i, l = "complete", m = "readyState",
                n = "attachEvent", o = "detachEvent", p = "addEventListener",
                q = "DOMContentLoaded", r = "onreadystatechange",
        ...
        var b = function () {
            ...
            var e = b.prototype = "function" == typeof a ? a.prototype : a,
                f = new b, g = d.apply(f, c.call(arguments, 2).concat(e));
