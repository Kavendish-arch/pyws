...
if __name__ == "__main__":
    ...
    #     sh['train'] = item.trainSet
    #     sh['test'] = item.testSet
    #     sh['train_len'] = item.trainSet_len
    #     sh['test_len'] = item.testSet_len


    # with closing(shelve.open('user_data','c')) as sh:
    #     sh['user'] = list(item.user_list.keys())
    #     sh['movie'] = item.movie_popular
    ...
    # ii = 0
    # with open('itemCF_data.csv', 'a') as rf:
